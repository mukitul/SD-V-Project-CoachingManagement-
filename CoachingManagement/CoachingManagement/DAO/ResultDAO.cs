...
namespace CoachingManagement
{
    class ResultDAO
    {
        ...
        public DataSet GetStudentResultWithId(string id)
        {
            connectionDB.OpenConnection();
            string sqlQuery = "select * from StudentResult where StudentId='"+id+"'";
            connectionDB.ExecuteQueries(sqlQuery);
            dataSet = new DataSet();
            dataSet = connectionDB.DataAdapter();
            connectionDB.CloseConnection();
        ...
        {
            connectionDB.OpenConnection();
            string sqlQuery = "select SubName as [Subject], ExamMarks as [Full Marks], ObtainedMarks as [Obtained Marks] from StudentResult where StudentId = '"+roll+"' and ExamType = '"+exam+"' ";
            connectionDB.ExecuteQueries(sqlQuery);
            dataSet = new DataSet();
            dataSet = connectionDB.DataAdapter();
            connectionDB.CloseConnection();
